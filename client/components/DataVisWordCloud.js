...
// var rootWords = Object.keys(this.props.userWords);
// var childrenWords = [];
// rootWords.forEach(function (word) {
//   childrenWords.push({ "name": word, "size": 50 });
// });
// var root = {
//   "name": "wordCloud",
...
class DataVisWordCloud extends Component {
  ...
  // componentDidMount() {
    // this.createSVGRoot();
    // this.createBubbles();
    // console.log(this.bubbleRoot);
  // }

  componentWillReceiveProps(nextProps) {
    var rootWords = Object.keys(nextProps.userWords);
    var childrenWords = [];
    rootWords.forEach(function (word) {
      childrenWords.push({ "name": word, "size": 50 });
    });
